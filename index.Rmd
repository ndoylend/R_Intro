...
*** =right
<center>
  <img height='375', alt='Vintage Calculator', src='assets/img/HP_35_Calculator.jpg' />
</center>

*** =fullwidth
Fantastic, so R can be used as a handy replacement for your vintage pocket calculator!
...
R comes with many built-in datasets to experiment with. The `mtcars` dataset was extracted from the 1974 Motor Trend US magazine, and comprises fuel consumption and 10 aspects of automobile design and performance for 32 automobiles (1973–74 models).
...
<img height='45', alt='R-Bloggers Logo', src='assets/img/R-Bloggers_Logo.png' /> R-Bloggers <http://www.r-bloggers.com/>
...
Presentation built with Slidify <https://github.com/ramnathv/slidify>
